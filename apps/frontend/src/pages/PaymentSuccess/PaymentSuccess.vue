      ...
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg border shadow-sm overflow-hidden">
          ...
          <div class="bg-green-50 p-6 border-b">
            <div class="flex flex-col items-center text-center">
              ...
              <p class="text-gray-600">Cảm ơn bạn đã đăng ký thành viên tại Elite Fitness Center</p>
            </div>
          </div>
          ...
          <div class="p-6">
            <div class="mb-6">
              <div class="flex justify-between items-center mb-4">
                ...
                <span class="text-sm text-gray-500">Mã đơn hàng: #ORD-{{ orderNumber }}</span>
              </div>

              <div class="bg-gray-50 rounded-lg border p-4 mb-6">
                <div class="flex flex-col md:flex-row">
                  <div class="md:w-1/4 mb-4 md:mb-0">
                    <img src="https://placehold.co/300x200" alt="Elite Fitness Center" class="w-full h-32 object-cover rounded-md" />
                  </div>
                  <div class="md:w-3/4 md:pl-6">
                    <h3 class="text-lg font-bold">Elite Fitness Center</h3>
                    <p class="text-gray-600 text-sm mb-2">789 Broadway, New York, NY 10003</p>

                    <div class="mt-3 flex items-center">
                      <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">Đang mở cửa</span>
                      <span class="text-sm text-gray-600 ml-2">5:00 AM - 11:00 PM</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-4">
                <div class="flex justify-between">
                  ...
                  <span class="font-medium">Premium Membership</span>
                </div>
                <div class="flex justify-between">
            ...
            <div class="mb-6">
              ...
              <div class="bg-gradient-to-r from-primary to-primary/80 rounded-lg p-6 text-white relative overflow-hidden">
                ...
                <div class="flex justify-between items-start mb-8 relative z-10">
                  ...
                  <div>
                    <span class="font-bold text-lg">Premium</span>
                  </div>
                </div>

                <div class="mb-6 relative z-10">
                  <div class="text-sm opacity-80 mb-1">Thành viên</div>
                  <div class="font-bold text-xl">Nguyễn Văn A</div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 relative z-10">
                  ...
                  <div>
                    ...
                    <div class="font-bold">{{ endDate }}</div>
                  </div>
                </div>
              ...
              <div class="space-y-4">
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">Tải ứng dụng FitFinder để dễ dàng quản lý thành viên và đặt lớp học.</p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">Cập nhật thông tin sức khỏe của bạn để nhận được lịch tập luyện phù hợp.</p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">Đặt lịch buổi tập đầu tiên với huấn luyện viên cá nhân miễn phí.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <button class="flex-1 px-4 py-3 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors flex items-center justify-center">
                <DownloadIcon class="h-5 w-5 mr-2" />
                Tải hóa đơn
              </button>
              <button class="flex-1 px-4 py-3 border border-primary text-primary rounded-md hover:bg-primary hover:text-white transition-colors flex items-center justify-center">
                <CalendarIcon class="h-5 w-5 mr-2" />
                Đặt lịch tập
              </button>
              <button class="flex-1 px-4 py-3 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors flex items-center justify-center">
        ...
        <div class="max-w-3xl mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-white p-6 rounded-lg border shadow-sm">
            ...
            <p class="text-sm text-gray-600">Chúng tôi đã gửi email xác nhận đến địa chỉ email của bạn với đầy đủ thông tin chi tiết.</p>
          </div>
          ...
          <div class="bg-white p-6 rounded-lg border shadow-sm">
            ...
            <p class="text-sm text-gray-600">Nếu bạn có bất kỳ câu hỏi nào, vui lòng liên hệ với đội ngũ hỗ trợ của chúng tôi.</p>
